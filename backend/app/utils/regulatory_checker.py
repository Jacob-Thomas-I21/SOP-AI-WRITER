...
class RegulatoryChecker:
        ...
        return {
            ...
            "electronic_records": {
                ...
                "validation_patterns": [
                    ...
                    r"\belectronic\s+signatures?\b",
                    r"\b21\s*CFR\s*(?:Part\s*)?11\b",
                    r"\bclosed\s+system\b",
                    r"\bopen\s+system\b",
                    r"\baudit\s+trail\b",
                ],
                "critical": True,
    ...
    def check_regulatory_compliance(
        self, content: str, frameworks: List[str], document_type: str = "sop"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            for framework in frameworks:
                ...
                if framework_key in self.regulatory_frameworks:
                    framework_result = self._check_framework_compliance(
                        content,
                        framework_key,
                        self.regulatory_frameworks[framework_key],
                    )
            ...
            compliance_results["overall_compliant"] = (
                compliance_results["compliance_score"] >= 70.0
                and len(compliance_results["missing_requirements"]) == 0
            )
    ...
    def _check_framework_compliance(
        self, content: str, framework_key: str, framework_config: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        element_score = (
            (len(element_matches) / len(required_elements)) * 100
        ...
        doc_score = (
            (len(doc_matches) / len(doc_requirements)) * 100 if doc_requirements else 0
        )
    ...
    def check_electronic_records_compliance(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "missing_requirements": [
                req for req in requirements if req not in matched_requirements
            ],
    ...
    def generate_compliance_report(
        ...
        try:
            ...
            electronic_records_result = self.check_electronic_records_compliance(
                content
            )
            ...
            report["overall_compliance"]["recommendations"] = list(
    ...
    def _check_rule_compliance(
        self, content: str, rule_config: Dict[str, Any], rule_name: str
    ) -> Dict[str, Any]:
    ...
    def _generate_compliance_recommendations(
        ...
        if compliance_results["compliance_score"] < 50:
            recommendations.append(
                "Critical: Comprehensive revision required for regulatory compliance"
            )
        elif compliance_results["compliance_score"] < 70:
            recommendations.append(
                "Major improvements needed to meet regulatory standards"
            )
        elif compliance_results["compliance_score"] < 85:
            recommendations.append(
                "Minor improvements recommended for optimal compliance"
            )

        # Framework-specific recommendations
        for framework, result in compliance_results.get(
            "framework_results", {}
        ).items():
    ...
    def get_supported_frameworks(self) -> Dict[str, Dict[str, Any]]:
        ...
        for key, config in self.regulatory_frameworks.items():
            framework_info[key] = {
                ...
                "documentation_requirements": len(
                    config.get("documentation_requirements", {})
                ),
